...
namespace DataObjects_Framework.BaseObjects
{
	...
	public class Base
	{
		...
		/// </summary>
		internal List<BaseTableDetail> mBase_TableDetail = new List<BaseTableDetail>();

		/// <summary>
		/// List of Row Detail objecs of the Data Object
		/// </summary>
		internal List<BaseRowDetail> mBase_RowDetail = new List<BaseRowDetail>();

		internal List<BaseListDetail> mBase_ListDetail = new List<BaseListDetail>();
		...
		public Base() 
		{
			...
			switch (Do_Globals.gSettings.pDataAccessType)
			{
				case Do_Constants.eDataAccessType.DataAccess_SqlServer:
					{
						this.mDa = new DataAccess_SqlServer();
						break;
					}
				case Do_Constants.eDataAccessType.DataAccess_WCF:
					{ 
						this.mDa = new DataAccess_Wcf();
						break;
					}
			}
		...
		protected virtual void Setup_AddListDetail(
			...
			, Base_List Obj_List
			, List<Do_Constants.Str_ForeignKeyRelation> CustomForeignKeys = null)
		{ this.mBase_ListDetail.Add(new BaseListDetail(this, Name, Obj_List, CustomForeignKeys)); }
		...
		public DataTable List(QueryCondition Condition)
		{ return this.List(Condition, "", 0, 0); }

		public DataTable List(QueryCondition Condition, String Sort)
		...
		/// </param>
		/// <returns></returns>
		public virtual DataTable List(QueryCondition Condition, String Sort, Int64 Top, Int32 Page)
		{
			try
			{
				this.mDa.Connect();
		...
		public DataTable List(Interface_DataAccess Da, QueryCondition Condition)
		{ return this.List(Da, Condition, "", 0, 0); }

		public DataTable List(Interface_DataAccess Da, QueryCondition Condition, String Sort)
		...
		/// <returns></returns>
		public virtual DataTable List(Interface_DataAccess Da, QueryCondition Condition, String Sort, Int64 Top, Int32 Page)
		{
			DataTable Dt = null;
		...
		/// </param>
		/// <returns></returns>
		public virtual Int64 List_Count(QueryCondition Condition = null)
		{
			Int64 Rv = 0;
			this.mDa.Connect();
		...
		/// </param>
		public virtual void Load(Keys Keys)
		{ this.Load(Keys, null); }
		...
		/// </param>
		public virtual void Load(Keys Keys, Base Obj_Parent)
		{
			try
			{
				this.mDa.Connect();
		...
		/// Key object to use, if null, it implies to create a new data object.
		/// </param>
		public virtual void Load(Interface_DataAccess Da, Keys Keys)
		{ this.Load(Da, Keys, (Base)null); }
		...
		/// The Parent Data Object.
		/// </param>
		public virtual void Load(Interface_DataAccess Da, Keys Keys, Base Obj_Parent)
		{
		...
		/// Key object to use.
		/// </param>
		protected void Load_Details(Keys Keys = null)
		{
		...
		/// Key object to use.
		/// </param>
		protected void Load_Details(Interface_DataAccess Da, Keys Keys = null)
		{
			if (this.mBase_TableDetail != null)
			{
				foreach (BaseTableDetail Inner_Obj in this.mBase_TableDetail)
			...
			{
				foreach (BaseListDetail Inner_Obj in this.mBase_ListDetail)
				{ Inner_Obj.Load(Da, Keys); }
			}
		}
		...
		/// </param>
		/// <returns></returns>
		public Keys GetKeys(DataRow Dr)
		{
			Keys Obj = new Keys();
		...
		/// </param>
		/// <returns></returns>
		public Keys GetKeys(DataRow Dr, List<string> KeyNames)
		{
			bool IsFound = true;
			Keys Key = new Keys();
		...
		protected virtual void AddRequired()
		{
			...
			foreach (BaseTableDetail Obj in this.mBase_TableDetail)
		...
		protected void CheckIfDeleted()
		{
			...
			if (IsDeleted) { throw new CustomException("This record is deleted."); }
		}
		...
		public Base_List pListDetail_Get(string Name)
		{
			BaseListDetail Ld = this.mBase_ListDetail.FirstOrDefault(Item => Item.pName == Name);
			Base_List Obj_List = null;
			if (Ld != null)
