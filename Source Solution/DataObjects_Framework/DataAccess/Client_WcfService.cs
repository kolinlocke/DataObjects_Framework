...
namespace DataObjects_Framework.DataAccess
{
    public class Client_WcfService : Interface_WcfService
    {
        ...
        {
            TimeSpan ConnectionTimeout = new TimeSpan(0, 10, 0);

            BasicHttpBinding Binding = new BasicHttpBinding();
            Binding.MaxReceivedMessageSize = Int32.MaxValue;
            Binding.SendTimeout = ConnectionTimeout;
            Binding.ReceiveTimeout = ConnectionTimeout;
        ...
        { return this.mChannel.ExecuteNonQuery(Request_Session, Request_Execute); }
